...
const ProviderManagement = ({ user }) => {
  ...
  const updateProviderInfo = () => {
    ...
    if (shouldUpdate) {
      ...
      dataSender
        .updateServiceProviderData(providerData, currentProvider.uid)
        .then(() => {
    ...
    <div className="provider-management">
      ...
      {loading ? (
        ...
        <>
          ...
          >
            <Table data={staffData} autoHeight width={1000}>
                ...
                <Table.Cell>
                  {(rowData) => (
                    <Button
                      ...
                      onClick={() =>
                        handleStaffSelection(currentProvider.uid, rowData.uid)
                      }
                    >
                      Update
                    </Button>
          ...
          <Panel
            ...
            header={
              <h3 className="provider-title">SERVICE IN THIS PROVIDER</h3>
            }
          >
            <Table data={serviceData} autoHeight width={1000}>
              <Table.Column width={200} align="center">
                ...
                <Table.Cell>
                  {(rowData) => (
                    <Button
                      className="provider-update-button"
                      onClick={() =>
                        handleServiceSelection(currentProvider.uid, rowData.id)
                      }
                    >
                      Update
                    </Button>
